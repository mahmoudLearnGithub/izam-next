import { svgContent_1 } from "../../public/svg";
import { svgContent_2 } from "../../public/svg";
import { svgContent_3 } from "../../public/svg";
import { svgContent_4 } from "../../public/svg";
            ...
            <div className="navbar-links">
                <ul>
                    <li className="first-block">
                        ...
                        {/* <span className="toggle-caret caret"
                            aria-label="Close Sidebar" onClick={closeListWithAnimation()}>
                            <svg className="svg-sm" width="8" height="13"
                                viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg"> <path
                                    d="M6.67572e-06 1.07499L1.06101 0.014986L6.84001 5.79199C6.93316 5.88455 7.00709 5.99463 7.05754 6.11588C7.10799 6.23713 7.13396 6.36716 7.13396 6.49849C7.13396 6.62981 7.10799 6.75984 7.05754 6.88109C7.00709 7.00234 6.93316 7.11242 6.84001 7.20499L1.06101 12.985L0.0010066 11.925L5.42501 6.49999L6.67572e-06 1.07499Z"
                                    fill="#C4C3C3" />
                            </svg>
                        </span> */}
                        <span className="toggle-caret caret"
                            aria-label="Close Sidebar" onClick={() => {}}>
                            <svg className="svg-sm" width="8" height="13"
                                viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg"> <path
                                    d="M6.67572e-06 1.07499L1.06101 0.014986L6.84001 5.79199C6.93316 5.88455 7.00709 5.99463 7.05754 6.11588C7.10799 6.23713 7.13396 6.36716 7.13396 6.49849C7.13396 6.62981 7.10799 6.75984 7.05754 6.88109C7.00709 7.00234 6.93316 7.11242 6.84001 7.20499L1.06101 12.985L0.0010066 11.925L5.42501 6.49999L6.67572e-06 1.07499Z"
                                    fill="#C4C3C3" />
...
{/* 
                    <li className="profile-toggle dropdown" onClick={dropDownMenuToggleFun()}>
                        <a
                            title="Profile Menu" href="html/profile.html" className="dropdown-toggle svg"
                            ...
                            <br /><label>Profile<svg className="svg caret" width="12" height="7"
                                viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg"> <path
                    ...
                    <li className="profile-toggle dropdown" >
                        <a
                            ...
                            <label>Profile<svg className="svg caret" width="12" height="7"
                                viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg"> <path
                                    d="M1.33984 0.5H10.375C11.0078 0.5 11.3242 1.27344 10.8672 1.73047L6.36719 6.23047C6.08594 6.51172 5.62891 6.51172 5.34766 6.23047L0.847656 1.73047C0.390625 1.27344 0.707031 0.5 1.33984 0.5Z"
                                    fill="#E6E6E6" /></svg></label>
                        </a>
                    ...
                    <li className="logout -sm"><a title="coming-soon Page"
                        href="./html/coming-soon.html">Logout </a> </li>
